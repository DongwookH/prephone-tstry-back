...
const FAQS = [
  ...
  },
  {
    ...
    a: "가장 흔한 원인 두 가지를 순서대로 확인해 보세요. 첫째, 설정 메뉴에 Gemini API 키가 정상적으로 등록되어 있는지 확인합니다. 둘째, guide 탭의 company·plans 두 섹션이 비어 있지 않은지 확인합니다. 이 두 섹션은 필수 항목이라 비어 있으면 글이 생성되지 않습니다.",
  },
  {
        ...
        <article className="max-w-[760px] mx-auto lg:mx-0 lg:flex-1 lg:max-w-[760px] min-w-0">
          ...
          <section>
            ...
            <Callout type="warning">
              ...
              채워주세요. company·plans를 비워두면 글 자체가 생성되지 않고,
