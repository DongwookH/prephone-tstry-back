        ...
        <article className="max-w-[760px] mx-auto lg:mx-0 lg:flex-1 lg:max-w-[760px] min-w-0">
          ...
          <section>
            ...
            <Callout type="warning">
              ...
              채워주세요. 필수 항목(판매점명 · 링크 · 회사 정보 · 요금표)이
              비어 있으면 글 자체가 생성되지 않습니다. 화면 위쪽 진행률이
              4/4가 되면 준비가 끝난 것입니다. 예시로 적어둔 값을 그대로 두면
              내 글에 엉뚱한 상호명이나 요금이 들어갈 수 있으니, 처음 시작할
              때는 항목을 처음부터 끝까지 한 번 훑어보며 내 정보로 채워져
              있는지 확인해 주세요.
            </Callout>
          </section>
