...
- (미납/정지 주제) 답 보강: "같은 통신사 망은 이력이 따라붙어 막히는 경우가 많아, 다른 망 선불유심으로 가야 인식돼요."
- (충전 주제) 답 보강: "충전은 앱이나 편의점에서 바로 되고, 남은 잔액도 문자로 확인돼요."
- (요금제 주제) 답 보강: "선불은 쓴 만큼 선결제라 약정·위약금 없이 매달 요금이 고정돼요."
- (eSIM/단말 주제) 답 보강: "eSIM이면 유심 배송 안 기다리고 QR로 바로 등록돼요."
- 프로필 유도(매번 변주): "본인 상황 순서는 프로필 링크에 있어요" / "정확한 준비물은 프로필에서 확인" / "케이스마다 달라서 프로필 링크에 케이스별로 정리" 등.
