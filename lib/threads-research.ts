...
# 🚫 절대 금지 — 미성년자 관련 콘텐츠 (정책상 차단)
- 미성년자/청소년/어린이/학생/자녀/만 14·15·17·18·19세 등 **미성년자 대상 또는 미성년자 언급**
  콘텐츠 일절 금지. 메인 글·셀프 댓글·예시 어디에도 등장시키지 말 것.
- "자녀 폰", "학생 요금제", "청소년 알뜰폰" 같은 변형 표현도 모두 금지.
- 위반 시 해당 초안은 폐기 — 반드시 성인 대상 톤·표현으로만 작성.
